...
@endif
<div class="sh-field" data-fs="1.5" style="left:{{ $shCfg['sig_right']['x'] }}%;top:{{ $shCfg['sig_top'] }}%;width:{{ $shCfg['sig_right']['w'] }}%;height:{{ $shCfg['sig_h'] }}%;">{{ $report->author->localized_name ?? '' }}</div>

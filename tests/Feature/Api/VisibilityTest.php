...
class VisibilityTest extends TestCase
{
    ...
    public function test_monitor_can_see_all_pending_notes(): void
    {
        $monitor1 = User::factory()->monitor()->create();
        $monitor2 = User::factory()->monitor()->create();
    ...
    public function test_monitor_can_see_all_accepted_notes(): void
    {
        $monitor1 = User::factory()->monitor()->create();
        $monitor2 = User::factory()->monitor()->create();
    ...
    public function test_monitor_can_see_all_rejected_notes(): void
    {
        $monitor1 = User::factory()->monitor()->create();
        $monitor2 = User::factory()->monitor()->create();
